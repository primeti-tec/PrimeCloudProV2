...
# Corrigir Erros 404 nos Botões de Ações Rápidas do Dashboard Plan

> Corrigir as rotas dos botões de ações rápidas no Dashboard que estão causando erro 404 ao redirecionar para rotas sem o prefixo /dashboard/
...
### Key Components
**Core Classes:**
- `DatabaseStorage` — D:\PROJETOS\PRINECLOUDPROV2\PrimeCloudProV2\server\storage.ts:106
- `SftpGoService` — D:\PROJETOS\PRINECLOUDPROV2\PrimeCloudProV2\server\services\sftpgo.service.ts:122
- `NotificationService` — D:\PROJETOS\PRINECLOUDPROV2\PrimeCloudProV2\server\services\notification.service.ts:45
- `MinioService` — D:\PROJETOS\PRINECLOUDPROV2\PrimeCloudProV2\server\services\minio.service.ts:100
- `BillingService` — D:\PROJETOS\PRINECLOUDPROV2\PrimeCloudProV2\server\services\billing.service.ts:70
...
- `IStorage` — D:\PROJETOS\PRINECLOUDPROV2\PrimeCloudProV2\server\storage.ts:13
- `MinioConfig` — D:\PROJETOS\PRINECLOUDPROV2\PrimeCloudProV2\server\services\minio.service.ts:25
- `BucketInfo` — D:\PROJETOS\PRINECLOUDPROV2\PrimeCloudProV2\server\services\minio.service.ts:33
## Agent Lineup
